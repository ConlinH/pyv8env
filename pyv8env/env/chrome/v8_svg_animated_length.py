...
class SVGAnimatedLength:
    ...
    def get_baseVal(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_animated_length.py -> SVGAnimatedLength.baseVal -> get attr')

    def get_animVal(self):
        val = self._attr.get('animVal')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_animated_length.py -> SVGAnimatedLength.animVal -> get attr')
