...
class SVGAnimatedEnumeration:
    ...
    def get_baseVal(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_animated_enumeration.py -> SVGAnimatedEnumeration.baseVal -> get attr')
    ...
    def get_animVal(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_animated_enumeration.py -> SVGAnimatedEnumeration.animVal -> get attr')
