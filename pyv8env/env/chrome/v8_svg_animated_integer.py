...
class SVGAnimatedInteger:
    ...
    def get_baseVal(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_animated_integer.py -> SVGAnimatedInteger.baseVal -> get attr')
    ...
    def get_animVal(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_animated_integer.py -> SVGAnimatedInteger.animVal -> get attr')
