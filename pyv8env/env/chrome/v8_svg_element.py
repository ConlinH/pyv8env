...
class SVGElement(Element):
    ...
    def __init__(self, *args, **kw):
        super(SVGElement, self).__init__(*args, **kw)

    __v8_attribute__ = (
        # (attr_name, get_cb, set_cb, CallbackType, FlagLocation, V8Attribute, FlagReceiverCheck, 
        # FlagCrossOriginCheck, FlagCrossOriginCheck, SideEffectType)
        ("className", "get_className", None, 0, 1, 0, 0, 0, 0, 1),
        ("ownerSVGElement", "get_ownerSVGElement", None, 0, 1, 0, 0, 0, 0, 1),
        ("viewportElement", "get_viewportElement", None, 0, 1, 0, 0, 0, 0, 1),
    ...
    def get_className(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.className -> get attr')

    def get_ownerSVGElement(self):
        val = self._attr.get('ownerSVGElement')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ownerSVGElement -> get attr')

    def get_viewportElement(self):
        val = self._attr.get('viewportElement')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.viewportElement -> get attr')

    def get_onbeforexrselect(self):
        val = self._attr.get('onbeforexrselect')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onbeforexrselect -> get attr')
    ...
    def get_onabort(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onabort -> get attr')
    ...
    def get_onbeforeinput(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onbeforeinput -> get attr')
    ...
    def get_onbeforematch(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onbeforematch -> get attr')
    ...
    def get_onbeforetoggle(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onbeforetoggle -> get attr')
    ...
    def get_onblur(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onblur -> get attr')
    ...
    def get_oncancel(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.oncancel -> get attr')
    ...
    def get_oncanplay(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.oncanplay -> get attr')
    ...
    def get_oncanplaythrough(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.oncanplaythrough -> get attr')
    ...
    def get_onchange(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onchange -> get attr')
    ...
    def get_onclick(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onclick -> get attr')
    ...
    def get_onclose(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onclose -> get attr')
    ...
    def get_oncontentvisibilityautostatechange(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.oncontentvisibilityautostatechange -> get attr')
    ...
    def get_oncontextlost(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.oncontextlost -> get attr')
    ...
    def get_oncontextmenu(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.oncontextmenu -> get attr')
    ...
    def get_oncontextrestored(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.oncontextrestored -> get attr')
    ...
    def get_oncuechange(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.oncuechange -> get attr')
    ...
    def get_ondblclick(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ondblclick -> get attr')
    ...
    def get_ondrag(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ondrag -> get attr')
    ...
    def get_ondragend(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ondragend -> get attr')
    ...
    def get_ondragenter(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ondragenter -> get attr')
    ...
    def get_ondragleave(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ondragleave -> get attr')
    ...
    def get_ondragover(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ondragover -> get attr')
    ...
    def get_ondragstart(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ondragstart -> get attr')
    ...
    def get_ondrop(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ondrop -> get attr')
    ...
    def get_ondurationchange(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ondurationchange -> get attr')
    ...
    def get_onemptied(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onemptied -> get attr')
    ...
    def get_onended(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onended -> get attr')
    ...
    def get_onerror(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onerror -> get attr')
    ...
    def get_onfocus(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onfocus -> get attr')
    ...
    def get_onformdata(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onformdata -> get attr')
    ...
    def get_oninput(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.oninput -> get attr')
    ...
    def get_oninvalid(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.oninvalid -> get attr')
    ...
    def get_onkeydown(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onkeydown -> get attr')
    ...
    def get_onkeypress(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onkeypress -> get attr')
    ...
    def get_onkeyup(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onkeyup -> get attr')
    ...
    def get_onload(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onload -> get attr')
    ...
    def get_onloadeddata(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onloadeddata -> get attr')
    ...
    def get_onloadedmetadata(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onloadedmetadata -> get attr')
    ...
    def get_onloadstart(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onloadstart -> get attr')
    ...
    def get_onmousedown(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onmousedown -> get attr')
    ...
    def get_onmouseenter(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onmouseenter -> get attr')
    ...
    def get_onmouseleave(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onmouseleave -> get attr')
    ...
    def get_onmousemove(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onmousemove -> get attr')
    ...
    def get_onmouseout(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onmouseout -> get attr')
    ...
    def get_onmouseover(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onmouseover -> get attr')
    ...
    def get_onmouseup(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onmouseup -> get attr')
    ...
    def get_onmousewheel(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onmousewheel -> get attr')
    ...
    def get_onpause(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onpause -> get attr')
    ...
    def get_onplay(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onplay -> get attr')
    ...
    def get_onplaying(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onplaying -> get attr')
    ...
    def get_onprogress(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onprogress -> get attr')
    ...
    def get_onratechange(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onratechange -> get attr')
    ...
    def get_onreset(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onreset -> get attr')
    ...
    def get_onresize(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onresize -> get attr')
    ...
    def get_onscroll(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onscroll -> get attr')
    ...
    def get_onsecuritypolicyviolation(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onsecuritypolicyviolation -> get attr')
    ...
    def get_onseeked(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onseeked -> get attr')
    ...
    def get_onseeking(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onseeking -> get attr')
    ...
    def get_onselect(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onselect -> get attr')
    ...
    def get_onslotchange(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onslotchange -> get attr')
    ...
    def get_onstalled(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onstalled -> get attr')
    ...
    def get_onsubmit(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onsubmit -> get attr')
    ...
    def get_onsuspend(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onsuspend -> get attr')
    ...
    def get_ontimeupdate(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ontimeupdate -> get attr')
    ...
    def get_ontoggle(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ontoggle -> get attr')
    ...
    def get_onvolumechange(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onvolumechange -> get attr')
    ...
    def get_onwaiting(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onwaiting -> get attr')
    ...
    def get_onwebkitanimationend(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onwebkitanimationend -> get attr')
    ...
    def get_onwebkitanimationiteration(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onwebkitanimationiteration -> get attr')
    ...
    def get_onwebkitanimationstart(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onwebkitanimationstart -> get attr')
    ...
    def get_onwebkittransitionend(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onwebkittransitionend -> get attr')
    ...
    def get_onwheel(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onwheel -> get attr')
    ...
    def get_onauxclick(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onauxclick -> get attr')
    ...
    def get_ongotpointercapture(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ongotpointercapture -> get attr')
    ...
    def get_onlostpointercapture(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onlostpointercapture -> get attr')
    ...
    def get_onpointerdown(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onpointerdown -> get attr')
    ...
    def get_onpointermove(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onpointermove -> get attr')
    ...
    def get_onpointerrawupdate(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onpointerrawupdate -> get attr')
    ...
    def get_onpointerup(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onpointerup -> get attr')
    ...
    def get_onpointercancel(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onpointercancel -> get attr')
    ...
    def get_onpointerover(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onpointerover -> get attr')
    ...
    def get_onpointerout(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onpointerout -> get attr')
    ...
    def get_onpointerenter(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onpointerenter -> get attr')
    ...
    def get_onpointerleave(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onpointerleave -> get attr')
    ...
    def get_onselectstart(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onselectstart -> get attr')
    ...
    def get_onselectionchange(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onselectionchange -> get attr')
    ...
    def get_onanimationend(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onanimationend -> get attr')
    ...
    def get_onanimationiteration(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onanimationiteration -> get attr')
    ...
    def get_onanimationstart(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onanimationstart -> get attr')
    ...
    def get_ontransitionrun(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ontransitionrun -> get attr')
    ...
    def get_ontransitionstart(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ontransitionstart -> get attr')
    ...
    def get_ontransitionend(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ontransitionend -> get attr')
    ...
    def get_ontransitioncancel(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ontransitioncancel -> get attr')
    ...
    def get_oncopy(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.oncopy -> get attr')
    ...
    def get_oncut(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.oncut -> get attr')
    ...
    def get_onpaste(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onpaste -> get attr')
    ...
    def get_dataset(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.dataset -> get attr')

    def get_nonce(self):
        val = self._attr.get('nonce')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.nonce -> get attr')
    ...
    def get_autofocus(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.autofocus -> get attr')
    ...
    def get_tabIndex(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.tabIndex -> get attr')
    ...
    def get_style(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.style -> get attr')
    ...
    def get_attributeStyleMap(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.attributeStyleMap -> get attr')

    def get_onfencedtreeclick(self):
        val = self._attr.get('onfencedtreeclick')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onfencedtreeclick -> get attr')
    ...
    def get_onoverscroll(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onoverscroll -> get attr')
    ...
    def get_onscrollend(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onscrollend -> get attr')
    ...
    def get_onscrollsnapchange(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onscrollsnapchange -> get attr')
    ...
    def get_onscrollsnapchanging(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.onscrollsnapchanging -> get attr')
    ...
    def get_ontouchcancel(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ontouchcancel -> get attr')
    ...
    def get_ontouchend(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ontouchend -> get attr')
    ...
    def get_ontouchmove(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ontouchmove -> get attr')
    ...
    def get_ontouchstart(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.ontouchstart -> get attr')
    ...
    def get_focusgroup(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.focusgroup -> get attr')

    def set_focusgroup(self, val):
        self._attr['focusgroup'] = val

    def fn_blur(self, *args):
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.blur{tuple(args)} -> method')

    def fn_focus(self, *args):
        logger.debug(f'patch -> v8_svg_element.py -> SVGElement.focus{tuple(args)} -> method')
