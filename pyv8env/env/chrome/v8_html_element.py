...
class HTMLElement(Element):
    ...
    def __init__(self, *args, **kw):
        super(HTMLElement, self).__init__(*args, **kw)
    ...
    __v8_attribute__ = (
        ...
        ("translate", "get_translate", "set_translate", 0, 1, 0, 0, 0, 0, 1),
        ("dir", "get_dir", "set_dir", 0, 1, 0, 0, 0, 0, 1),
        ("hidden", "get_hidden", "set_hidden", 0, 1, 0, 0, 0, 0, 1),
        ("inert", "get_inert", "set_inert", 0, 1, 0, 0, 0, 0, 1),
        ("accessKey", "get_accessKey", "set_accessKey", 0, 1, 0, 0, 0, 0, 1),
        ("draggable", "get_draggable", "set_draggable", 0, 1, 0, 0, 0, 0, 1),
        ("spellcheck", "get_spellcheck", "set_spellcheck", 0, 1, 0, 0, 0, 0, 1),
        ("autocapitalize", "get_autocapitalize", "set_autocapitalize", 0, 1, 0, 0, 0, 0, 1),
        ("editContext", "get_editContext", "set_editContext", 0, 1, 0, 0, 0, 0, 1),
        ("contentEditable", "get_contentEditable", "set_contentEditable", 0, 1, 0, 0, 0, 0, 1),
        ("enterKeyHint", "get_enterKeyHint", "set_enterKeyHint", 0, 1, 0, 0, 0, 0, 1),
        ("isContentEditable", "get_isContentEditable", None, 0, 1, 0, 0, 0, 0, 1),
        ("inputMode", "get_inputMode", "set_inputMode", 0, 1, 0, 0, 0, 0, 1),
        ("virtualKeyboardPolicy", "get_virtualKeyboardPolicy", "set_virtualKeyboardPolicy", 0, 1, 0, 0, 0, 0, 1),
        ("offsetParent", "get_offsetParent", None, 0, 1, 0, 0, 0, 0, 1),
        ("offsetTop", "get_offsetTop", None, 0, 1, 0, 0, 0, 0, 1),
        ("offsetLeft", "get_offsetLeft", None, 0, 1, 0, 0, 0, 0, 1),
        ("offsetWidth", "get_offsetWidth", None, 0, 1, 0, 0, 0, 0, 1),
        ("offsetHeight", "get_offsetHeight", None, 0, 1, 0, 0, 0, 0, 1),
        ("popover", "get_popover", "set_popover", 0, 1, 0, 0, 0, 0, 1),
        ("innerText", "get_innerText", "set_innerText", 0, 1, 0, 0, 0, 0, 1),
        ("outerText", "get_outerText", "set_outerText", 0, 1, 0, 0, 0, 0, 1),
        ...
        ("writingSuggestions", "get_writingSuggestions", "set_writingSuggestions", 0, 1, 0, 0, 0, 0, 1),
    ...
    __v8_method__ = (
        ...
        ("attachInternals", "fn_attachInternals", 0, 0, 1, 0, 0, 0, 0),
        ("blur", "fn_blur", 0, 0, 1, 0, 0, 0, 0),
        ("click", "fn_click", 0, 0, 1, 0, 0, 0, 0),
        ("focus", "fn_focus", 0, 0, 1, 0, 0, 0, 0),
        ("hidePopover", "fn_hidePopover", 0, 0, 1, 0, 0, 0, 0),
        ("showPopover", "fn_showPopover", 0, 0, 1, 0, 0, 0, 0),
        ("togglePopover", "fn_togglePopover", 0, 0, 1, 0, 0, 0, 0),
    ...
    def get_title(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.title -> get attr')
    ...
    def get_lang(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.lang -> get attr')

    def set_lang(self, val):
        self._attr['lang'] = val

    def get_translate(self):
        val = self._attr.get('translate')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.translate -> get attr')

    def set_translate(self, val):
        self._attr['translate'] = val

    def get_dir(self):
        val = self._attr.get('dir')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.dir -> get attr')
    ...
    def get_hidden(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.hidden -> get attr')

    def set_hidden(self, val):
        self._attr['hidden'] = val

    def get_inert(self):
        val = self._attr.get('inert')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.inert -> get attr')

    def set_inert(self, val):
        self._attr['inert'] = val

    def get_accessKey(self):
        val = self._attr.get('accessKey')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.accessKey -> get attr')

    def set_accessKey(self, val):
        self._attr['accessKey'] = val

    def get_draggable(self):
        val = self._attr.get('draggable')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.draggable -> get attr')

    def set_draggable(self, val):
        self._attr['draggable'] = val

    def get_spellcheck(self):
        val = self._attr.get('spellcheck')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.spellcheck -> get attr')

    def set_spellcheck(self, val):
        self._attr['spellcheck'] = val

    def get_autocapitalize(self):
        val = self._attr.get('autocapitalize')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.autocapitalize -> get attr')

    def set_autocapitalize(self, val):
        self._attr['autocapitalize'] = val

    def get_editContext(self):
        val = self._attr.get('editContext')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.editContext -> get attr')

    def set_editContext(self, val):
        self._attr['editContext'] = val

    def get_contentEditable(self):
        val = self._attr.get('contentEditable')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.contentEditable -> get attr')

    def set_contentEditable(self, val):
        self._attr['contentEditable'] = val

    def get_enterKeyHint(self):
        val = self._attr.get('enterKeyHint')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.enterKeyHint -> get attr')

    def set_enterKeyHint(self, val):
        self._attr['enterKeyHint'] = val

    def get_isContentEditable(self):
        val = self._attr.get('isContentEditable')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.isContentEditable -> get attr')

    def get_inputMode(self):
        val = self._attr.get('inputMode')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.inputMode -> get attr')

    def set_inputMode(self, val):
        self._attr['inputMode'] = val

    def get_virtualKeyboardPolicy(self):
        val = self._attr.get('virtualKeyboardPolicy')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.virtualKeyboardPolicy -> get attr')

    def set_virtualKeyboardPolicy(self, val):
        self._attr['virtualKeyboardPolicy'] = val

    def get_offsetParent(self):
        val = self._attr.get('offsetParent')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.offsetParent -> get attr')

    def get_offsetTop(self):
        val = self._attr.get('offsetTop')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.offsetTop -> get attr')

    def get_offsetLeft(self):
        val = self._attr.get('offsetLeft')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.offsetLeft -> get attr')

    def get_offsetWidth(self):
        val = self._attr.get('offsetWidth')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.offsetWidth -> get attr')

    def get_offsetHeight(self):
        val = self._attr.get('offsetHeight')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.offsetHeight -> get attr')

    def get_popover(self):
        val = self._attr.get('popover')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.popover -> get attr')

    def set_popover(self, val):
        self._attr['popover'] = val

    def get_innerText(self):
        val = self._attr.get('innerText')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.innerText -> get attr')

    def set_innerText(self, val):
        self._attr['innerText'] = val

    def get_outerText(self):
        val = self._attr.get('outerText')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.outerText -> get attr')

    def set_outerText(self, val):
        self._attr['outerText'] = val

    def get_onbeforexrselect(self):
        val = self._attr.get('onbeforexrselect')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onbeforexrselect -> get attr')
    ...
    def get_onabort(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onabort -> get attr')
    ...
    def get_onbeforeinput(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onbeforeinput -> get attr')
    ...
    def get_onbeforematch(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onbeforematch -> get attr')
    ...
    def get_onbeforetoggle(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onbeforetoggle -> get attr')
    ...
    def get_onblur(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onblur -> get attr')
    ...
    def get_oncancel(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.oncancel -> get attr')
    ...
    def get_oncanplay(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.oncanplay -> get attr')
    ...
    def get_oncanplaythrough(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.oncanplaythrough -> get attr')
    ...
    def get_onchange(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onchange -> get attr')
    ...
    def get_onclick(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onclick -> get attr')
    ...
    def get_onclose(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onclose -> get attr')
    ...
    def get_oncontentvisibilityautostatechange(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.oncontentvisibilityautostatechange -> get attr')
    ...
    def get_oncontextlost(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.oncontextlost -> get attr')
    ...
    def get_oncontextmenu(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.oncontextmenu -> get attr')
    ...
    def get_oncontextrestored(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.oncontextrestored -> get attr')
    ...
    def get_oncuechange(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.oncuechange -> get attr')
    ...
    def get_ondblclick(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ondblclick -> get attr')
    ...
    def get_ondrag(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ondrag -> get attr')
    ...
    def get_ondragend(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ondragend -> get attr')
    ...
    def get_ondragenter(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ondragenter -> get attr')
    ...
    def get_ondragleave(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ondragleave -> get attr')
    ...
    def get_ondragover(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ondragover -> get attr')
    ...
    def get_ondragstart(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ondragstart -> get attr')
    ...
    def get_ondrop(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ondrop -> get attr')
    ...
    def get_ondurationchange(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ondurationchange -> get attr')
    ...
    def get_onemptied(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onemptied -> get attr')
    ...
    def get_onended(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onended -> get attr')
    ...
    def get_onerror(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onerror -> get attr')
    ...
    def get_onfocus(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onfocus -> get attr')
    ...
    def get_onformdata(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onformdata -> get attr')
    ...
    def get_oninput(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.oninput -> get attr')
    ...
    def get_oninvalid(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.oninvalid -> get attr')
    ...
    def get_onkeydown(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onkeydown -> get attr')
    ...
    def get_onkeypress(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onkeypress -> get attr')
    ...
    def get_onkeyup(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onkeyup -> get attr')
    ...
    def get_onload(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onload -> get attr')
    ...
    def get_onloadeddata(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onloadeddata -> get attr')
    ...
    def get_onloadedmetadata(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onloadedmetadata -> get attr')
    ...
    def get_onloadstart(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onloadstart -> get attr')
    ...
    def get_onmousedown(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onmousedown -> get attr')
    ...
    def get_onmouseenter(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onmouseenter -> get attr')
    ...
    def get_onmouseleave(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onmouseleave -> get attr')
    ...
    def get_onmousemove(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onmousemove -> get attr')
    ...
    def get_onmouseout(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onmouseout -> get attr')
    ...
    def get_onmouseover(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onmouseover -> get attr')
    ...
    def get_onmouseup(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onmouseup -> get attr')
    ...
    def get_onmousewheel(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onmousewheel -> get attr')
    ...
    def get_onpause(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onpause -> get attr')
    ...
    def get_onplay(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onplay -> get attr')
    ...
    def get_onplaying(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onplaying -> get attr')
    ...
    def get_onprogress(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onprogress -> get attr')
    ...
    def get_onratechange(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onratechange -> get attr')
    ...
    def get_onreset(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onreset -> get attr')
    ...
    def get_onresize(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onresize -> get attr')
    ...
    def get_onscroll(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onscroll -> get attr')
    ...
    def get_onsecuritypolicyviolation(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onsecuritypolicyviolation -> get attr')
    ...
    def get_onseeked(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onseeked -> get attr')
    ...
    def get_onseeking(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onseeking -> get attr')
    ...
    def get_onselect(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onselect -> get attr')
    ...
    def get_onslotchange(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onslotchange -> get attr')
    ...
    def get_onstalled(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onstalled -> get attr')
    ...
    def get_onsubmit(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onsubmit -> get attr')
    ...
    def get_onsuspend(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onsuspend -> get attr')
    ...
    def get_ontimeupdate(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ontimeupdate -> get attr')
    ...
    def get_ontoggle(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ontoggle -> get attr')
    ...
    def get_onvolumechange(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onvolumechange -> get attr')
    ...
    def get_onwaiting(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onwaiting -> get attr')
    ...
    def get_onwebkitanimationend(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onwebkitanimationend -> get attr')
    ...
    def get_onwebkitanimationiteration(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onwebkitanimationiteration -> get attr')
    ...
    def get_onwebkitanimationstart(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onwebkitanimationstart -> get attr')
    ...
    def get_onwebkittransitionend(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onwebkittransitionend -> get attr')
    ...
    def get_onwheel(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onwheel -> get attr')
    ...
    def get_onauxclick(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onauxclick -> get attr')
    ...
    def get_ongotpointercapture(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ongotpointercapture -> get attr')
    ...
    def get_onlostpointercapture(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onlostpointercapture -> get attr')
    ...
    def get_onpointerdown(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onpointerdown -> get attr')
    ...
    def get_onpointermove(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onpointermove -> get attr')
    ...
    def get_onpointerrawupdate(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onpointerrawupdate -> get attr')
    ...
    def get_onpointerup(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onpointerup -> get attr')
    ...
    def get_onpointercancel(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onpointercancel -> get attr')
    ...
    def get_onpointerover(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onpointerover -> get attr')
    ...
    def get_onpointerout(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onpointerout -> get attr')
    ...
    def get_onpointerenter(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onpointerenter -> get attr')
    ...
    def get_onpointerleave(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onpointerleave -> get attr')
    ...
    def get_onselectstart(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onselectstart -> get attr')
    ...
    def get_onselectionchange(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onselectionchange -> get attr')
    ...
    def get_onanimationend(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onanimationend -> get attr')
    ...
    def get_onanimationiteration(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onanimationiteration -> get attr')
    ...
    def get_onanimationstart(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onanimationstart -> get attr')
    ...
    def get_ontransitionrun(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ontransitionrun -> get attr')
    ...
    def get_ontransitionstart(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ontransitionstart -> get attr')
    ...
    def get_ontransitionend(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ontransitionend -> get attr')
    ...
    def get_ontransitioncancel(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ontransitioncancel -> get attr')
    ...
    def get_oncopy(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.oncopy -> get attr')
    ...
    def get_oncut(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.oncut -> get attr')
    ...
    def get_onpaste(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onpaste -> get attr')
    ...
    def get_dataset(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.dataset -> get attr')

    def get_nonce(self):
        val = self._attr.get('nonce')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.nonce -> get attr')
    ...
    def get_autofocus(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.autofocus -> get attr')
    ...
    def get_tabIndex(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.tabIndex -> get attr')
    ...
    def get_style(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.style -> get attr')
    ...
    def get_attributeStyleMap(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.attributeStyleMap -> get attr')

    def get_writingSuggestions(self):
        val = self._attr.get('writingSuggestions')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.writingSuggestions -> get attr')

    def set_writingSuggestions(self, val):
        self._attr['writingSuggestions'] = val

    def get_onfencedtreeclick(self):
        val = self._attr.get('onfencedtreeclick')
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onfencedtreeclick -> get attr')
    ...
    def get_onoverscroll(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onoverscroll -> get attr')
    ...
    def get_onscrollend(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onscrollend -> get attr')
    ...
    def get_onscrollsnapchange(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onscrollsnapchange -> get attr')
    ...
    def get_onscrollsnapchanging(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.onscrollsnapchanging -> get attr')
    ...
    def get_ontouchcancel(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ontouchcancel -> get attr')
    ...
    def get_ontouchend(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ontouchend -> get attr')
    ...
    def get_ontouchmove(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ontouchmove -> get attr')
    ...
    def get_ontouchstart(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.ontouchstart -> get attr')
    ...
    def get_focusgroup(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.focusgroup -> get attr')

    def set_focusgroup(self, val):
        self._attr['focusgroup'] = val

    def fn_attachInternals(self, *args):
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.attachInternals{tuple(args)} -> method')

    def fn_blur(self, *args):
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.blur{tuple(args)} -> method')

    def fn_click(self, *args):
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.click{tuple(args)} -> method')

    def fn_focus(self, *args):
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.focus{tuple(args)} -> method')

    def fn_hidePopover(self, *args):
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.hidePopover{tuple(args)} -> method')

    def fn_showPopover(self, *args):
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.showPopover{tuple(args)} -> method')

    def fn_togglePopover(self, *args):
        logger.debug(f'patch -> v8_html_element.py -> HTMLElement.togglePopover{tuple(args)} -> method')
