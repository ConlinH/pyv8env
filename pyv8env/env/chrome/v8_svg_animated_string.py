...
class SVGAnimatedString:
    ...
    def get_baseVal(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_animated_string.py -> SVGAnimatedString.baseVal -> get attr')
    ...
    def get_animVal(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_animated_string.py -> SVGAnimatedString.animVal -> get attr')
