...
class SVGAnimatedNumber:
    ...
    def get_baseVal(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_animated_number.py -> SVGAnimatedNumber.baseVal -> get attr')
    ...
    def get_animVal(self):
        ...
        if val is not None:
            return val
        logger.debug(f'patch -> v8_svg_animated_number.py -> SVGAnimatedNumber.animVal -> get attr')
